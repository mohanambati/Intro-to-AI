...
// Program Name: prog2_1.c
// 
// Description:
//	
//  This program takes the initial state in the command line in the format XXXXXXXXX, 
...
/***********************************************************************************************************************************************************/
//     /* Function to remove element in the priority queue */
/***********************************************************************************************************************************************************/
...
/***********************************************************************************************************************************************************/
//     /* Function to estimate heuristic cost */
/***********************************************************************************************************************************************************/
...
int heuristic_cost_estimate(struct Node* node)
{
	...
	for(int j =0; j <3; j++)
	{
		if(node->data[i][j] != goal_state1[count])
		hscore++;
	count++;
	}
	return hscore;
...
/***********************************************************************************************************************************************************/
//     /* Function to finds the least heuristic node and returns it.*/
/***********************************************************************************************************************************************************/
...
/***********************************************************************************************************************************************************/
//     /* Function to compare heuristic scores of 2 nodes.*/
/***********************************************************************************************************************************************************/
...
/***********************************************************************************************************************************************************/
//     /* Function to perform A* Algoritham.*/
/***********************************************************************************************************************************************************/
...
struct Node* Astar(struct Node* node)
{
	...
	if(goal_check(found->data)){ //printf("goal found. \n \n"); 
	return found;}
...
/***********************************************************************************************************************************************************/
//     /* Function to find the result path.*/
/***********************************************************************************************************************************************************/
